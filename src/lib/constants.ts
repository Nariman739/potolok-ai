...
export const PRODUCT_ITEMS: ProductItem[] = [
  ...
  { code: "gardina_plastic", name: "Гардина обычная на потолок", unit: "м.п.", defaultPrice: 5000, category: "gardina" },
  { code: "gardina_aluminum", name: "Гардина встроенная в натяжной", unit: "м.п.", defaultPrice: 17000, category: "gardina" },
