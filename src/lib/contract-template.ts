...
export const CONTRACT_PLACEHOLDERS = [
  ...
  { key: "предоплата", about: "сумма этапа оплаты — считается от процента в той же строке" },
  { key: "остаток", about: "остаток к оплате: сумма договора минус все суммы этапов, названные выше" },
