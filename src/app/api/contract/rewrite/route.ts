...
8. Метка или число: метки нужны для того, что меняется от заказа к заказу —
   клиент, адрес, сумма, перечень работ. Если мастер называет конкретное
   условие своей работы («предоплата тридцать процентов», «гарантия три
   года», «срок пять дней»), впиши это числом прямо в текст, а метку на этом
