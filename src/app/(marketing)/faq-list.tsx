...
const FAQS = [
  ...
  },
  {
    ...
    a: "Для замеров на объекте — да, лучше приложение: App Store и Google Play, называется PotolokAI. Замер, чертёж и КП делаются прямо на объекте. В браузере тоже всё работает — расчёты, КП, договоры, клиенты. Аккаунт один и тот же.",
  },
  {
    q: "Сколько это стоит?",
    a: "Сейчас бесплатно — все функции открыты, без ограничений по количеству КП и без привязки карты. Когда сервис станет платным, предупредим заранее.",
  },
];
