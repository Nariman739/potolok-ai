...
type ChecklistItem = {
  ...
  href?: string;
  hrefLabel?: string;
  // Для пункта-логотипа — вторая кнопка для AI
  aiAction?: boolean;
};
...
export function OnboardingChecklist({
  ...
  const items: ChecklistItem[] = [
    ...
    },
    {
      ...
      label: "Логотип — будет в КП и договоре",
      href: "/dashboard/profile",
      hrefLabel: "Загрузить",
      aiAction: true,
    },
                  ...
                  <div className="flex items-center gap-2">
                    {it.aiAction && (
                      <button
                        ...
                        className="text-xs font-medium text-[#1e3a5f] hover:underline inline-flex items-center gap-0.5"
                      >
